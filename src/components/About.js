...
function About() {
  return (
    <div style={{ padding: "40px", color: "#ECEBEA", textAlign: "center", backgroundColor: "rgba(52, 52, 52, 0.32)", borderRadius: "8px", boxShadow: "0 4px 8px rgba(0, 0, 0, 0.3)", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "center", gap: "20px", marginTop: "20px" }}>
        <img
          ...
          alt="Logo EPN"
          style={{ width: "150px", height: "150px", borderRadius: "8px", boxShadow: "0 4px 8px rgba(0, 0, 0, 0.3)" }}
        />
        <img
          src="logo.png"
          alt="Logo Delta CEP"
